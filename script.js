...
switch(age){
    case (16): document.write('Já pode votar!');
    break;

    case (18): document.write('Já pode beber e dirigir, não ao mesmo tempo!');
    break;

    case (65): document.write('Já pode pegar ônibus de graça!')
    break;
